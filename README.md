...
Sitio web para una empresa de servicios eléctricos construido con Next.js.

`Next.js` `React` `CSS`

[Repositorio](https://github.com/fabianf4/projectInrelectricasIMAC) · [Live](https://project-inrelectricas-imac.vercel.app/)
...
Reto de Frontend Mentor — diseño de página de noticias con CSS Grid.

`HTML` `CSS`

[Repositorio](https://github.com/fabianf4/challenge-2-frontendmentor-) · [Live](https://fabianf4.github.io/challenge-2-frontendmentor-/)
...
Reto de Frontend Mentor — landing page responsiva con bloques alternados.

`HTML` `CSS`

[Repositorio](https://github.com/fabianf4/challenge-1-frontendmentor) · [Live](https://fabianf4.github.io/challenge-1-frontendmentor/)
...
Sitio web de turismo espacial construido con JavaScript.

`JavaScript`

[Repositorio](https://github.com/fabianf4/SpaceTourismWebsite)
...
Website for an electrical services company built with Next.js.

`Next.js` `React` `CSS`

[Repository](https://github.com/fabianf4/projectInrelectricasIMAC) · [Live](https://project-inrelectricas-imac.vercel.app/)
...
Frontend Mentor challenge — news homepage layout with CSS Grid.

`HTML` `CSS`

[Repository](https://github.com/fabianf4/challenge-2-frontendmentor-) · [Live](https://fabianf4.github.io/challenge-2-frontendmentor-/)
...
Frontend Mentor challenge — responsive landing page with alternating feature blocks.

`HTML` `CSS`

[Repository](https://github.com/fabianf4/challenge-1-frontendmentor) · [Live](https://fabianf4.github.io/challenge-1-frontendmentor/)
...
Space tourism website built with JavaScript.

`JavaScript`

[Repository](https://github.com/fabianf4/SpaceTourismWebsite)
